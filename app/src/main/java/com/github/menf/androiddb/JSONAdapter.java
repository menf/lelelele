...
// See if there is a cover ID in the Object
        if (jsonObject.has("cover_i")) {
            ...
            Picasso.with(mContext).load(imageURL).placeholder(R.drawable.brazowa).into(holder.thumbnailImageView);
        } else {

            // If there is no cover ID in the object, use a placeholder
            holder.thumbnailImageView.setImageResource(R.drawable.brazowa);
        }
